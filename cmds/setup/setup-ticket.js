...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if(!perms) {
            ...
            .setColor(ee.color)
            return message.reply(nopermsembed);
        }
        if(perms) {
                ...
                if(!args[0] === "set" || !args[0] === "unset" || !args[0] === "message") {
                    ...
                    .setColor(ee.color)
                    return message.reply(usesetunsetmessageembed);
                }
                else {
                    if(args[0] === "set") {
                        if(inenmap) {
                        ...
                        if(!inenmap) {
                            if(!channel) {
                                ...
                                .setColor(ee.color)
                                let themsg = await channel.send(embed4);
                                themsg.react("🎫");
                ...
                if(!args[0]) {
                    ...
                    .setDescription("Please use \`\`set\`\` or \`\`unset\`\` or \`\`message\`\`!")
                    .setColor(ee.color)
                    return message.reply(usesetunsetmessageembed2);
